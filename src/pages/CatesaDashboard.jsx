...
const COMING_SOON = [
  { icon: ClipboardCheck, label: 'Fiscalizações',         desc: 'Vistorias de saneamento básico' },
  { icon: AlertTriangle,  label: 'Autos de Infração',     desc: 'Gestão de autos e sanções' },
...
export default function CatesaDashboard() {
  return (
    <CamaraLayout
      sigla="CATESA"
      nome="Câmara Técnica de Saneamento"
      navItems={NAV_ITEMS}
    >
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-cyan-100 text-sm">
                  Câmara Técnica de Saneamento — em implementação
                </p>
              </div>
            </div>
          </div>
