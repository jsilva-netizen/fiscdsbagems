          ...
          <div className="mx-auto max-w-6xl space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-3 md:grid-cols-5">
                <div className="flex flex-col justify-between rounded-2xl border border-gray-200 bg-white p-3 shadow-sm">
                  <div className="mb-2"><div className="rounded-md p-1.5 bg-teal-50 w-fit"><FileText className="h-4 w-4 text-teal-700" /></div></div>
                  <div><div className="text-xl font-extrabold tracking-tight text-gray-900">{tnVal(tnData.length)}</div><div className="mt-0.5 text-[11px] font-semibold text-gray-500">Total de TNs</div></div>
                </div>
                <div className="flex flex-col justify-between rounded-2xl border border-gray-200 bg-white p-3 shadow-sm">
                  <div className="mb-2"><div className="rounded-md p-1.5 bg-blue-50 w-fit"><Clock className="h-4 w-4 text-blue-700" /></div></div>
                  <div><div className="text-xl font-extrabold tracking-tight text-gray-900">{tnVal(tnAguardandoResposta)}</div><div className="mt-0.5 text-[11px] font-semibold text-gray-500">Aguardando resposta</div></div>
                </div>
                <div className={`flex flex-col justify-between rounded-2xl border bg-white p-3 shadow-sm ${tnPrazoVencido > 0 ? 'border-rose-200' : 'border-gray-200'}`}>
                  <div className="mb-2"><div className="rounded-md p-1.5 bg-rose-50 w-fit"><TimerOff className="h-4 w-4 text-rose-700" /></div></div>
                  <div><div className={`text-xl font-extrabold tracking-tight ${tnPrazoVencido > 0 ? 'text-rose-600' : 'text-gray-900'}`}>{tnVal(tnPrazoVencido)}</div><div className="mt-0.5 text-[11px] font-semibold text-gray-500">Prazo vencido</div></div>
                </div>
                <div className="flex flex-col justify-between rounded-2xl border border-gray-200 bg-white p-3 shadow-sm">
                  <div className="mb-2"><div className="rounded-md p-1.5 bg-amber-50 w-fit"><GitMerge className="h-4 w-4 text-amber-700" /></div></div>
                  <div><div className="text-xl font-extrabold tracking-tight text-gray-900">{tnVal(tnRespondido)}</div><div className="mt-0.5 text-[11px] font-semibold text-gray-500">Respondidos</div></div>
                </div>
                <div className="flex flex-col justify-between rounded-2xl border border-gray-200 bg-white p-3 shadow-sm">
                  ...
                  <div><div className="text-xl font-extrabold tracking-tight text-gray-900">{tnVal(tnPendenteTN + tnAguardandoAssinatura)}</div><div className="mt-0.5 text-[11px] font-semibold text-gray-500">Pendente de emissão</div></div>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-2xl bg-gray-100 p-6 shadow-sm">
              ...
              {loading ? (
                <div className="rounded-xl bg-white p-5 text-sm text-gray-500">Carregando…</div>
              ) : !d?.lists.followUpProcesses.length ? (
                <div className="rounded-xl bg-white p-5 text-sm text-gray-500">Nenhum processo em acompanhamento.</div>
              ) : (
                    ...
                    >
                      <div className="flex min-w-0 items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="truncate text-sm font-bold text-gray-900 group-hover:text-emerald-700">
                      ...
                      <div className="hidden shrink-0 items-center gap-1.5 sm:flex">
                        ...
                        {p.recommendations_overdue > 0 && (
                          <span className="rounded-full bg-rose-50 px-2.5 py-1 text-[10px] font-bold uppercase tracking-tight text-rose-700">
            ...
            <div className="flex flex-wrap items-end justify-between gap-4">
              <h2 className="text-xs font-bold uppercase tracking-widest text-gray-400">Avisos</h2>
              <Button
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-3">
                <h3 className="text-lg font-bold text-gray-900">Respostas atrasadas</h3>
                <span className="rounded-full bg-rose-50 px-2.5 py-0.5 text-xs font-bold text-rose-700">{overdueUnread}</span>
              </div>
              ...
              {alertsQ.isLoading ? (
                ...
                <div className="rounded-2xl border border-dashed border-gray-200 bg-white p-10 text-center">
                  ...
                  <div className="font-semibold text-gray-900">Nenhuma resposta atrasada.</div>
                  <div className="mt-1 text-sm text-gray-500">Acompanhe aqui quando algum prazo expirar.</div>
                </div>
              ) : (
                <div className="space-y-3">
                  {alertsData.overdueResponses.map((p) => {
                    ...
                    return (
                      <div key={key} className="flex items-start justify-between gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md">
                        ...
                        <button type="button"
                          className={`shrink-0 rounded-lg border px-4 py-2 text-xs font-bold transition-colors ${
                            isRead ? 'border-gray-200 text-gray-400' : 'border-blue-200 text-[#0066B3] hover:bg-blue-50'
                          }`}
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-3">
                <h3 className="text-lg font-bold text-gray-900">Recomendações vencidas</h3>
              ...
              {alertsQ.isLoading ? (
                ...
                <div className="rounded-2xl border border-dashed border-gray-200 bg-white p-10 text-center">
                  ...
                  <div className="font-semibold text-gray-900">Nenhuma recomendação vencida.</div>
                  <div className="mt-1 text-sm text-gray-500">As pendências dentro do prazo aparecem na página de recomendações.</div>
                </div>
              ) : (
                <div className="space-y-3">
                    ...
                    return (
                      <div key={key} className="flex items-start justify-between gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md">
                        <div className="flex gap-4">
                          ...
                          <div className="min-w-0">
                            <div className="text-sm font-bold text-gray-900">{r.description}</div>
                            <div className="mt-1 text-sm text-gray-600">
                              Processo:{' '}
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-3">
                <h3 className="text-lg font-bold text-gray-900">Aguardando análise</h3>
                <span className="rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-bold text-gray-600">{awaitingUnread}</span>
              </div>

              {alertsQ.isLoading ? (
                <div className="rounded-xl bg-white p-5 text-sm text-gray-500">Carregando…</div>
              ) : !alertsData?.awaitingAnalysis.length ? (
                <div className="rounded-2xl border border-dashed border-gray-200 bg-gray-100 p-10 text-center">
                  <div className="mx-auto mb-3 grid h-14 w-14 place-items-center rounded-full bg-white shadow-sm">
                    <Search className="h-7 w-7 text-gray-400" />
                  </div>
                  <div className="font-semibold text-gray-900">Nenhum item aguardando análise.</div>
                  <div className="mt-1 text-sm text-gray-500">Todos os processos foram revisados ou estão com prazos regulares.</div>
                </div>
              ) : (
                <div className="space-y-3">
                      ...
                      <div key={key} className="flex items-start justify-between gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md">
                        <div className="flex gap-4">
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="mt-1 text-sm text-gray-600">Status: aguardando análise desde {formatIsoDateHuman(p.created_at)}.</div>
                          </div>
                        </div>
                        <button type="button"
                          className={`shrink-0 rounded-lg border px-4 py-2 text-xs font-bold transition-colors ${
            ...
            {alertCount === 0 && !alertsQ.isLoading && (
              <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-emerald-300/60 bg-emerald-50/30 py-16 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">Nenhum alerta pendente no momento.</p>
              </div>
            )}
          </div>
        </div>
