...
import { Search, FolderOpen, MapPin, Building2, Calendar } from 'lucide-react';
...
export default function CatersFiscalizacoes() {
  const [busca, setBusca] = useState('');

  const { data: fiscalizacoes = [], isLoading } = useQuery({
    queryKey: ['caters-fiscalizacoes'],
    queryFn: async () => {
